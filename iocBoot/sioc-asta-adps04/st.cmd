...
epicsEnvSet("PREFIX", "ASPS04:")
epicsEnvSet("XSIZE",  "1600")
epicsEnvSet("YSIZE",  "1200")
epicsEnvSet("NELEM",  "2000000")
epicsEnvSet("ID",     "192.168.1.102")
epicsEnvSet("DESC",   "ASTA Cam 4")
...
dbLoadRecords("$(TOP)/db/thumbnails.db", "P=$(PREFIX)image1:ArrayData")
