...
epicsEnvSet("PREFIX", "13PS15:")
epicsEnvSet("XSIZE",  "1292")
epicsEnvSet("YSIZE",  "964")
epicsEnvSet("NELEM",  "1300000")
epicsEnvSet("ID",     "5013811")
epicsEnvSet("DESC",   "PROF 2055")
...
dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX),R=image1:,PORT=Image1,ADDR=0,TIMEOUT=1,TYPE=Int8,FTVL=UCHAR,NELEMENTS=$(NELEM)")
...
#dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX),R=image1:,PORT=Image1,ADDR=0,TIMEOUT=1,TYPE=Int16,FTVL=SHORT,NELEMENTS=$(NELEM)")
